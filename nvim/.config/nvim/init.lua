...
-- Remaps
--	Split Navigation
vim.keymap.set('n', '<leader>h', '<C-w>h', {desc = 'Move focus to left split'})
vim.keymap.set('n', '<leader>j', '<C-w>j', {desc = 'Move focus to lower split'})
vim.keymap.set('n', '<leader>k', '<C-w>k', {desc = 'Move focus to upper split'})
vim.keymap.set('n', '<leader>l', '<C-w>l', {desc = 'Move focus to right split'})
--	Quickfix
vim.keymap.set('n','<C-j>','<cmd>cnext<CR>',{desc = 'Next quickfix location'})
vim.keymap.set('n','<C-k>','<cmd>cprev<CR>',{desc = 'Prev quickfix location'})
vim.keymap.set('n','<leader>qo', '<cmd>cope<CR>',{desc = 'Open Quickfix'})
vim.keymap.set('n','<leader>qq', '<cmd>ccl<CR>',{desc = 'Close quickfix'})
